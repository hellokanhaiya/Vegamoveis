...
//           `https://api.themoviedb.org/3/discover/movie?api_key=089ff97e142c4b012df105099009a50b&page=${currentPage}&query=${searchQuery}`
//         );
//         if (!response.ok) {
...
const Home = ({ searchQuery }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // let url = `https://api.themoviedb.org/3/discover/movie?api_key=089ff97e142c4b012df105099009a50b&page=`;
        let url = `https://api.themoviedb.org/3/discover/movie?api_key=089ff97e142c4b012df105099009a50b&page=${currentPage}&with_genres=&include_adult=false&query=
`;
  ...
  return (
    <div className="bg-[#191919] p-5">
      {movies.length > 0 ? (
        ...
        <p className="text-center text-white">No search results found.</p>
      )}
