    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          ...
          `https://api.themoviedb.org/3/discover/movie?api_key=089ff97e142c4b012df105099009a50b&page=${currentPage}&with_genres=878&include_adult=false&query=
`
        );
        if (!response.ok) {
